...
import { setCloseModalRemoveLiquidity } from "@/redux/slice/modalSlice";
import {
  Flex,
  Modal,
  ModalBody,
...
import { FormRemoveLiquidity } from "../form";

export const ModalRemoveLiquidity = () => {
  ...
  return (
    <Modal
      isOpen={modalRemoveLiquidity.isOpen}
